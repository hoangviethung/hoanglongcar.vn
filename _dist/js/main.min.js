...
var showNaviationMobile = function showNaviationMobile() {
  ...
  var btnClose = document.querySelector('.navigation .btn-close');
...
var ajaxFilterProducts = function ajaxFilterProducts() {
  ...
  var listProductCurrent = $('.list-product');
...
var cartTotal = function cartTotal() {
  ...
  if (cartTotal) {
    var temp = parseInt(document.querySelector('.temp').textContent = tempCartTotal());
    var service = parseInt(cartTotal.querySelector('.service').textContent);
    var tax = parseInt(cartTotal.querySelector('.tax').textContent);
    var discount = parseInt(cartTotal.querySelector('.discount').textContent);
    var total = cartTotal.querySelector('.total');
